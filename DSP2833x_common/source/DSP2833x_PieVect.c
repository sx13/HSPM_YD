...
//==========================================================================
// 
// 文件名:	DSP2833x_PieVect.c
//
// 用途:	DSP28335的中断向量表初始化
//
// 说明:	
...
#include "DSP2833x_Device.h"     	// DSP2833x寄存器头文件
#include "DSP2833x_DefaultIsr.h"    // DSP2833x中断向量申明列表
